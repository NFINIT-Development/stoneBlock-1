...
mods.avaritia.ExtremeCrafting.addShaped("Transmutation Table", < projecte: transmutation_table > , [
  ...
  [ < avaritia: resource: 3 > , < mekanism: polyethene: 2 > , < tconstruct: ingots: 3 > , < projecte:condenser_mk2 > , < actuallyadditions: item_misc: 19 > , < projecte:condenser_mk2 > , < tconstruct: ingots: 3 > , < mekanism: polyethene: 2 > , < avaritia: resource: 3 > ],
...
mods.avaritia.ExtremeCrafting.addShaped("Transmutation Tablet", < projecte: item.pe_transmutation_tablet > , [
  ...
  [ < avaritia: resource: 4 > , < projecte: matter_block: 1 > , < avaritia: resource: 6 > , < projecte:condenser_mk2 > , < actuallyadditions: item_misc: 19 > , < projecte:condenser_mk2> , < avaritia: resource: 6 > , < projecte: matter_block: 1 > , < avaritia: resource: 4 > ],
